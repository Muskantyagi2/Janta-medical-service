    ...
    >
      ...
      >
        ...
        <p className="text-gray-600 mb-8">
          {" "}
          Sign In to your account to get started with fast and reliable medicine
          deliveries.
        </p>
        ...
        <button
          className="w-full font-semibold py-2 rounded-lg transition duration-200 text-white cursor-pointer"
          style={{
        ...
        <button
          className="w-full mt-4 flex items-center justify-center gap-2 rounded-lg px-4 py-2 transition cursor-pointer duration-200"
          style={{
            border: `1px solid ${borderColor}`,
        ...
        >
          ...
          <span style={{ color: primaryColor }}>Sign Up</span>
        </p>
      </div>
    </div>
  );
